...
import part3 from "../../assets/images/carousels/part3.png"; // Destination BG

const CarouselEffect = () => {
  return (
    <div className="relative w-full max-w-6xl mx-auto overflow-hidden rounded-xl bg-white border-2 border-borderbg  p-1 ">
      ...
      <div className="absolute inset-0">
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 1.5, duration: 0.6 }}
          className="absolute top-[16%] sm:top-[18%] left-[5%] w-[90%] text-center text-black z-40"
        >
          <p className="text-[10px] xs:text-xs sm:text-sm md:text-[12px]  lg:text-[16px] xl:text-[20px] font-semibold leading-tight sm:leading-snug md:leading-normal">
